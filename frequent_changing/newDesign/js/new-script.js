(function ($) {
  ...
  $(document).ready(function(){
    //console.log('Yes');
    $('.main-sidebar .sidebar-toggle .inner-circle').trigger('click');
    $('.main-sidebar .sidebar-toggle .inner-circle').click();
    //$('.main-sidebar .sidebar-toggle').click();
    //console.log($('.main-sidebar .sidebar-toggle')  );
  });
})(jQuery);
