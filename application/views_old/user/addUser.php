                            ...
                            <div class="form-group radio_button_problem">
                                ...
                                <div class="radio">
                                    <label>
                                        ...
                                        <input tabindex="6" type="radio" <?php echo set_checkbox('will_login',"No")?> name="will_login" id="will_login_no" value="No"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 mb-2 col-md-3">
                                <div class="form-group">
                                    ...
                                    <input tabindex="2" type="number" id="login_pin" onfocus="select();" name="login_pin" class="form-control"
