            ...
            <div class="left_item">
                <div class="header_part_middle">
                    ...
                    <ul class="icon__menu the-main-icon-menu">
                        ...
                        <li class="has__children be-last <?php echo escape_output($is_self_order_class) ?>">
            ...
            <div class="main_right <?php echo escape_output($is_self_order_class) ? 'online_order':'' ?>">
                <form autocomplete="off" class="search-category-form" id="search_form">
                    ...
                    <div class="search-category-item">
                        <div class="item">
                            <table style="width: 100%">
                                <tr>
                                    <td><input class="" type="text" name="search" id="search" placeholder="<?php echo lang('name_code_cat_veg_bev_bar'); ?>" /></td>
                    ...
                    <?php else:   ?>
                        <table style="width: 100%">
                            <tr>
                                <td> <input class="ir_w_m_b_4" type="text" name="search" id="search" placeholder="<?php echo lang('name_code_cat_veg_bev_bar'); ?>" /></td>
                                <td><input style="margin-top: -5px;" type="text" name="search_barcode" id="search_barcode" placeholder="<?php echo lang('scan_a_barcode'); ?>" /></td>
                            </tr>
                        </table>
