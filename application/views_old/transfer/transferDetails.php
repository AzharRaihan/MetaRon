                        ...
                        <div class="form-group">
                            ...
                            <p>
                                ...
                                if($transfer_details->status==1){
                                    echo escape_output(lang('Received'));
                                }elseif($transfer_details->status==2){
                                    echo escape_output(lang('hold'));
                                }elseif($transfer_details->status==3){
                                    echo escape_output(lang('Sent'));
                                }
                                ?>
                            </p>
                        </div>
                            ...
                            <table class="table">
                                ...
                                foreach ($food_details as $key=>$value):
                                    ...
                                    <tr class="rowCount" data-item_id="<?=$value->ingredient_id?>" data-id="<?=$key?>" id="row_<?=$key?>">
                                        ...
                                        <td><span><?=$name?> </td>
                                        <td><?=getAmtPCustom($value->quantity_amount)?> <?=$unit?></td>
                                        <td class="men_div display_none"><?=getAmtPCustom($value->total_cost)?></td>
