...
<input type="hidden" id="transfer_id_c" value="<?php echo escape_output($encrypted_id)?>">
    ...
    <div class="box-wrapper">
            ...
            <div class="table-box">
                ...
                <div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select tabindex="4" class="form-control select2 select2-hidden-accessible ir_w_100"
                                ...
                                ?>
                                <option <?=$transfer_details->status && $transfer_details->status=="2"?'selected':''?>  value="2"><?php echo lang('hold'); ?></option>
                                ...
                                ?>
                                <option disabled value="2"><?php echo lang('hold'); ?></option>
                    ...
                    <div class="col-md-3" style="display: <?php echo escape_output($display_none_1)?>">
                    ...
                    <input type="hidden" id="is_disabled_change" value="<?php echo escape_output($dis_status)?>">
                                ...
                                <?php
                                    foreach ($food_details as $key=>$value):
                                        ...
                                        if($value->transfer_type==1){
                                            ...
                                            $unit = unitName(getPurchaseUnitIdByIgId($value->ingredient_id));
                                        }else{
