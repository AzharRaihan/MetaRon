...
<section class="main-content-wrapper">
    ...
    <section class="content-header">
        <h3 class="text-left top-left-header"><?php echo lang('abcAnalysisReport'); ?></h3>

        <input type="hidden" class="datatable_name" data-title="<?php echo lang('abcAnalysisReport'); ?>" data-id_name="datatable">
        ...
        <div class="table-box">
            <div class="row">
                <div class="mb-3 col-md-4 col-lg-2 col-sm-12">
                    <?php echo form_open(base_url() . 'Report/abcAnalysisReport', $arrayName = array('id' => 'abcAnalysisReport')) ?>
            ...
            <div class="table-responsive">
                ...
                <table id="datatable" class="table">
                    ...
                    <tr>
                        ...
                        <th>Profit %</th>
                        <th><?php echo lang('cum_ratios'); ?></th>
                        <th>Sale <?php echo lang('ranking'); ?></th>
                        <th>Revenue <?php echo lang('ranking'); ?></th>
                        <th>Profit <?php echo lang('ranking'); ?></th>
                    </tr>
                    </thead>
                    <tbody>
                    <?php
                    $total_revenue = 0;
                    $g_total_profit = 0;
                    if (isset($abcAnalysisReport)):

                     $inline_total_profit = 0;
                    foreach ($abcAnalysisReport as $key => $value) {
                        ...
                        foreach ($abcAnalysisReport as $key => $value) {
                            ...
                            <tr>
                                ...
                                <td><?php echo escape_output(number_format($sale_qty_p,2)) ?></td>
                                <td><?php echo escape_output(number_format($com_ratio_sale_qty,2)) ?></td>
                                <td><?php echo escape_output(number_format($price,2)) ?></td>
                                <td><?php echo escape_output(number_format($revenue,2)) ?></td>
                                <td><?php echo escape_output(number_format($revenue_p,2)) ?></td>
                                <td><?php echo escape_output(number_format($com_ratio_revenue,2)) ?></td>
                                <td><?php echo escape_output(number_format($total_cost,2)) ?></td>
                                <td><?php echo escape_output(number_format($total_unit_cost,2)) ?></td>
                                <td><?php echo escape_output(number_format($unit_profit,2)) ?></td>
                                <td><?php echo escape_output(number_format($total_profit,2)) ?></td>
                                <td><?php echo escape_output(number_format($inline_total_profit_1,2)) ?></td>
                                <td><?php echo escape_output(number_format($com_ratio_profit,2)) ?></td>
