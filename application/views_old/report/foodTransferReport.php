                            ...
                            <div class="col-sm-12 col-md-4 col-lg-2 mb-3">
                                <div class="form-group">
                                    <select tabindex="4" class="form-control select2 select2-hidden-accessible ir_w_100"
                                            name="from_storage_id" id="from_storage_id">
                                        <option value=""><?php echo lang('select'); ?></option>
                                        <option <?php echo isset($from_storage_id) && $from_storage_id==0?'selected':''?> value="0"><?php echo lang('main_storage'); ?></option>
                                        <?php foreach ($kitchens as $value) {
                                            ?>
                                            <option  value="<?php echo escape_output($value->id) ?>"
                                                     <?php echo isset($from_storage_id) && $from_storage_id==$value->id?'selected':''?>
                                                <?php echo set_select('from_storage_id', $value->id); ?>>
                                                <?php echo escape_output($value->name) ?></option>
                                            <?php
                                        } ?>
                                    </select>
                                </div>
                                <?php if (form_error('from_storage_id')) { ?>
                                    <div class="callout callout-danger my-2">
                                        <?php echo form_error('from_storage_id'); ?>
                                    </div>
                                <?php } ?>
                                </div>
                        <div class="col-sm-12 col-md-4 col-lg-2 mb-3">
                                <div class="form-group">
                                        <select tabindex="4" class="form-control select2 select2-hidden-accessible ir_w_100"
                                            ...
                                            <option value=""><?php echo lang('select'); ?></option>
                                            <option <?php echo isset($storage_id) && $storage_id==0?'selected':''?> value="0"><?php echo lang('main_storage'); ?></option>
                                            <?php foreach ($kitchens as $value) {
                                                ?>
                                                <option  value="<?php echo escape_output($value->id) ?>"
                                                         <?php echo isset($storage_id) && $storage_id==$value->id?'selected':''?>
                                                    <?php echo set_select('storage_id', $value->id); ?>>
                                                    <?php echo escape_output($value->name) ?></option>
                                                <?php
                                            } ?>
                                        </select>
                                        <?php if (form_error('storage_id')) { ?>
                                            <div class="callout callout-danger my-2">
                                                <?php echo form_error('storage_id'); ?>
                                            </div>
                                        <?php } ?>
                                    </div>
                                </div>
                            ...
                            <div class="table-responsive">
                                ...
                                <table id="datatable" class="table">
                                    ...
                                    <tr>
                                        ...
                                        <th ><?php echo lang('from_outlet'); ?></th>
                                    ...
                                    if (isset($foodTransferReport)):
                                        foreach ($foodTransferReport as $key => $value) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo escape_output($value->from_storage_id?getStorageName($value->from_storage_id):lang('main_storage')); ?></td>
                                                <td><?php echo escape_output($value->storage_id?getStorageName($value->storage_id):lang('main_storage')); ?></td>
