...
<section class="main-content-wrapper">
    ...
    <section class="content-header">
        <h3 class="text-left top-left-header"><?php echo lang('landingPage')?> </h3>
    </section>
    ...
    <div class="box-wrapper">
        ...
        <div class="table-box">
            ...
            <ul class="nav nav-tabs">
                <li class="nav-item" role="presentation"><button class="nav-link active" data-bs-toggle="tab" data-bs-target="#pring_plan"><?php echo lang('Pricing_Plans')?></button></li>
                <li class="nav-item" role="presentation"><button class="nav-link" data-bs-toggle="tab" data-bs-target="#Customer_Review"><?php echo lang('Customer_Review')?></button></li>
                <li class="nav-item" role="presentation"><button class="nav-link" data-bs-toggle="tab" data-bs-target="#Counter"><?php echo lang('Counter')?></button></li>
                <li class="nav-item" role="presentation"><button class="nav-link" data-bs-toggle="tab" data-bs-target="#social_link"><?php echo lang('social_link')?></button></li>
            </ul>
