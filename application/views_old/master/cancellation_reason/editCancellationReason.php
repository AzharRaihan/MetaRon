...
<section class="main-content-wrapper">
    <section class="content-header">
        <h3 class="top-left-header">
            <?php echo lang('editCancellationReasons'); ?>
        </h3>
    </section>
        ...
        <div class="box-wrapper">
            ...
            <div class="table-box">
                ...
                <?php echo form_open(base_url('CancellationReason/addEditCancellationReason/' . $encrypted_id)); ?>
                <div>
                    <div class="row">
                        <div class="col-sm-12 mb-2 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input tabindex="1" type="text" name="name" class="form-control"
                                    ...
                                    value="<?php echo escape_output($cancellation_reason->name) ?>">
                            </div>
