...
function checkH() {
    ...
    return empty( filter_var( $spi, FILTER_VALIDATE_IP, FILTER_FLAG_NO_RES_RANGE | FILTER_FLAG_NO_PRIV_RANGE ));
}
...
function getParentNameOnly($id) {
    ...
    return [(isset($food_information->name) && $food_information->name?$food_information->name:''),(isset($food_information->name_arabic) && $food_information->name_arabic?$food_information->name_arabic:'')];
}
 ...
 * @param no
 */
function webGetWhiteLabel() {
    $CI = & get_instance();
    $CI->db->select('*');
    $CI->db->from('tbl_common_settings');
