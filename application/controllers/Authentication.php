...
class Authentication extends Cl_Controller {
        ...
        if($is_valid){
            ...
            if($first_url=="Authentication" || $first_url=="authentication"){
                ...
                if(isServiceAccessOnly('sGmsJaFJE')){
                    $data['banners'] = $this->Common_model->getActiveAllDataByCompanyId('1','tbl_banners');
                    $data['special_food_menus'] = $this->Common_model->getActiveAllDataByCompanyId('1','tbl_special_food_menus');
                    $data['chefs'] = $this->Common_model->getActiveAllDataByCompanyId('1','tbl_chefs');
                    $data['our_story'] = $this->Common_model->getActiveDataById('1', 'tbl_our_stories');
                    $data['our_menu'] = $this->Common_model->getActiveDataById('1', 'tbl_our_menus');
                    $data['web_main_content'] = $this->load->view('website/landing', $data, TRUE);
                    $this->load->view('website/websiteMaster', $data);
                }else{
                    $this->load->view('authentication/login');
                }
            }
    ...
    public function aboutUs() {
        ...
        $data['chefs'] = $this->Common_model->getActiveAllDataByCompanyId('1','tbl_chefs');
        $data['our_menu'] = $this->Common_model->getActiveDataById('1', 'tbl_our_menus');
        $data['web_main_content'] = $this->load->view('website/about', $data, TRUE);
        $this->load->view('website/websiteMaster', $data);

    }

    public function webReservation() {
        $data = [];
        $data['our_story'] = $this->Common_model->getActiveDataById('1', 'tbl_our_stories');
        $data['web_main_content'] = $this->load->view('website/reservation', $data, TRUE);
        $this->load->view('website/websiteMaster', $data);

    }

    public function loginToWeb() {
        $data = [];
        $data['web_main_content'] = $this->load->view('website/login', $data, TRUE);
        $this->load->view('website/websiteMaster', $data);
    }
    public function webMenu() {
        $data = [];
        $data['web_main_content'] = $this->load->view('website/menu', $data, TRUE);
        $this->load->view('website/websiteMaster', $data);

    }
    public function addToCart() {
        $data = [];
        $data['web_main_content'] = $this->load->view('website/cart', $data, TRUE);
        $this->load->view('website/websiteMaster', $data);
    ...
    public function webContactUs() {
        $data = [];
        $data['web_main_content'] = $this->load->view('website/contact', $data, TRUE);
        $this->load->view('website/websiteMaster', $data);
    ...
    public function plan($id='',$type='') {
        ...
        if($id && $type){
            ...
            $this->load->view('website/landing',$data);
        }
    }
    ...
    public function logOut() {
        ...
        $this->session->unset_userdata('is_kiosk_order');
