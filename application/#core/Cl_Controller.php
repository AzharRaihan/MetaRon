          ...
          $file_pointer_i = str_rot13('nffrgf/oyhrvzc/ERFG_NCV_V.wfba');
           if (file_exists($file_pointer_i)) {
               ...
               if (str_rot13($server_url) != 'ybpnyubfg') {
                   ...
                   $installation_url_new = (checkH())?str_rot13('ybpnyubfg').$first_segment[1]:str_replace('www.','',str_replace('https:','',str_replace('/','',str_replace('http://','',$_SERVER['HTTP_HOST'].$first_segment[1]))));
