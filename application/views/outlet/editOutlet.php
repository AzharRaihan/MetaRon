                                ...
                                <select tabindex="2" class="form-control select2" name="order_receiving_id" id="order_receiving_id">
                                    ...
                                    foreach ($waiters as $value):
                                        if($value->designation=="Cashier"):
                                            ?>
                                            <option <?php echo ($outlet_information->order_receiving_id==$value->id)?'selected':''?>  <?php echo set_select('order_receiving_id',$value->id)?> value="<?=$value->id?>"><?=$value->full_name?></option>
                                            <?php
                                        endif;
                                    endforeach;
                                    ?>
