            ...
            <div class="row">
                ...
                <div class="col-sm-12 mb-2 col-md-6">
                    <div class="form-group">
                        ...
                        <select tabindex="2" class="form-control select2" name="order_receiving_id" id="order_receiving_id">
                            <option value=""><?php echo lang('select'); ?></option>
                            <?php
                            foreach ($waiters as $value):
                        ...
                        foreach ($items as $item) {
                            ...
                            <div class="col-sm-12 mb-3 col-md-6 col-lg-4">
                                ...
                                <div class="form-group outlet-price-field">
                                    ...
                                    <input  type="text" value="<?php echo escape_output($sale_de_price)?>" name="price_ta_<?php echo escape_output($item->id)?>" placeholder="<?php echo lang('price');?><?php echo lang('TA'); ?>" onfocus="select()" class="form-control txt_21">
                                </div>
                                <?php if(!sizeof($deliveryPartners)):?>
                                    <div class="form-group outlet-price-field">
                                        <label class="txt_outlet_1"><?php echo lang('price'); ?><?php echo lang('De'); ?></label>
                                        <input  type="text" value="<?php echo escape_output($sale_ta_price)?>" name="price_de_<?php echo escape_output($item->id)?>" placeholder="<?php echo lang('price');?><?php echo lang('De'); ?>" onfocus="select()" class="form-control txt_21">
                                    </div>
                                <?php else:?>
