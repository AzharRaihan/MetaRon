...
$is_kiosk_order = $this->session->userdata('is_kiosk_order');
...
foreach ($customers as $customer){
    ...
    if($customer->name=='Walk-in Customer'){
        $customers_option = '<option '.$selected.' data-default_discount="'.$customer->default_discount.'"  data-customer_address="'.getPlanText($customer->address).'" data-customer_gst_number="'.getPlanText($customer->gst_number).'" data-current_due="'.$current_due.'" value="'.$customer->id.'" selected>'.(getPlanText($customer->name)).' '.$customer->phone.'</option>'.$customers_option;
    }else{
        $customers_option .= '<option '.$selected.' data-default_discount="'.$customer->default_discount.'"  data-customer_address="'.getPlanText($customer->address).'" data-customer_gst_number="'.getPlanText($customer->gst_number).'" data-current_due="'.$current_due.'" value="'.$customer->id.'" '.$selected.'>'.(getPlanText($customer->name)).' '.$customer->phone.'</option>';
    }

    if($total_customers==$i){
        $customer_objects .= "{customer_id:'".$customer->id."',default_discount:'".$customer->default_discount."',customer_name:'".(getPlanText($customer->name))."',customer_address:'".getPlanText($customer->address)."',gst_number:'".$customer->gst_number."'}";
    }else{
        $customer_objects .= "{customer_id:'".$customer->id."',default_discount:'".$customer->default_discount."',customer_name:'".(getPlanText($customer->name))."',customer_address:'".getPlanText($customer->address)."',gst_number:'".$customer->gst_number."'},";
    }
...
foreach($tables as $table){
    ...
    $tables_modal .= '<div class="column first_column">Order</div>';
    $tables_modal .= '<div class="column second_column">Time</div>';
    $tables_modal .= '<div class="column third_column">Person</div>';
    $tables_modal .= '<div class="column forth_column">Del</div>';
    $tables_modal .= '</div>';
    $tables_modal .= '</div>';
    $tables_modal .= '<div class="bottom" id="single_table_order_details_bottom_'.$table->id.'">';
    $tables_modal .= '<input type="text" name="" placeholder="Order" class="bottom_order"  id="single_table_order_details_bottom_order_'.$table->id.'" readonly>';
    ...
    $tables_modal .= '<button class="bottom_add"  data-name="'.$table->name.'"  id="single_table_order_details_bottom_add_'.$table->id.'">Add</button>';
    $tables_modal .= '</div>';
    $tables_modal .= '</div>';
    $tables_modal .= '</div>';
}
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/POS/css/bespoke.css">
    ...
    <link rel="stylesheet" href="<?php echo base_url();?>assets/POS/css/modal_screen.css">
    <link rel="stylesheet" href="<?php echo base_url();?>assets/POS/css/finalize_new_design.css">
    <style>
    <?php
...
<?php $this->view('sale/POS/hidden_input_html'); ?>
    ...
    <div id="main-wrapper-content" class="wrapper">
        <!-- Main Header Part -->
        <?php if($is_kiosk_order!="Yes"):?>
        <div class="top_header_part  <?php echo escape_output($is_self_order_class) ?> <?php echo escape_output($is_self_order_class)?'self_order_mode':'' ?>">
            <div class="left_item">
                <div class="header_part_middle">

                    <ul class="icon__menu the-main-icon-menu">
                        ...
                        <?php if($is_self_order_class):
                            ...
                            <li  style="display: <?php echo isset($is_kiosk_order) && $is_kiosk_order=="Yes"?"none":''?>" class="self_order_and_online_order">
                        ...
                        <?php else:?>
                                <li>
                                <a href="<?php echo base_url();?>Authentication/logOut"  data-tippy-content="<?php echo lang('logout'); ?>" class="header_menu_icon "
                                ><i class="fa fa-sign-out"> </i></a>
                            </li>
                        <?php endif;?>
                            <li class="ro-containers">
                            <div  class="pos_outlet_info_ro_toggle"><i class="	fas fa-angle-right"></i> <?php echo 'RO'?></div>
                        </li>
                        

                        <li class="has__children be-last">
                            <a href="#" class="btn header_menu_icon" data-tippy-content="<?php echo lang('Options'); ?>">
                                <i class="fa fa-ellipsis-v"></i> <?php echo lang('Options'); ?>
                            </a>
                            <ul class="sub__menu option-sub-menu" role="menu">
                                <li>
                                ...
                                <li class="has__children_sub <?php echo escape_output($is_self_order_class) ?>">
            ...
            <div class="header_part_right">
                <ul class="btn__menu btn__menu_left <?php echo escape_output($is_self_order_class) ?>">
                    ...
                    <li class="has__children pos-user-profile">
                        
                            <span><?php echo escape_output($this->session->userdata('full_name')); ?> &nbsp;</span>
                            <a href="#" class="header_menu_icon" data-tippy-content="<?php echo lang('main_menu'); ?>">
                                <i class="fal fa-user blue-text"></i> 
                            </a>
                            <ul class="sub__menu" role="menu">
                                <li>
                                    <a
        ...
        <div class="top_header_for_mobile <?php echo escape_output($is_self_order_class)?'self_order_mode':'' ?>">
            ...
            <div class="for-mobile-mode">
                ...
                <?php else:?>
                    ...
                    <?php if($is_self_order=="Yes" && $is_online_order!="Yes"):?>
                        <button  style="display: <?php echo isset($is_kiosk_order) && $is_kiosk_order=="Yes"?"none":''?>" type="button" class="self_my_order bg__green"> <span><?php echo lang('My_Orders'); ?></span></button>
                    <?php endif?>
                ...
                <?php if($is_online_order=="Yes"):
                    ...
                    <button type="button" class="self_order_and_online_order online_order_after_login irp_my_orders edit_customer bg__green" style="display:<?php echo escape_output($online_login)?>"> <span><?php echo lang('edit_profile'); ?></span></button>
        ...
        <div id="main_part">
            <div class="left_item <?php echo escape_output($is_self_order_class) ? 'self_order_mode':'' ?>">
                <div class="main_left  <?php echo escape_output($is_self_order_class) ?>">
                    <div class="holder">
                        ...
                        <div id="left_side_button_holder_absolute">
                            ...
                            <button class="no-need-for-waiter operation_button fix" id="print_kot"><i
                            ...
                            if(isset($waiter_app_status) && $waiter_app_status=="Yes" && $getCompanyInfo->printing_kot!="web_browser"):
                                ?>
                                <button class="operation_button fix btn_tip full-width-for-waiter" data-tippy-content="<?php echo lang('print'); ?> <?php echo lang('KOT'); ?>" id="print_kot"><i
                ...
                <div class="main_middle" style="<?php echo escape_output($is_self_order_class)?'width: 100%;':'' ?>">
                    <div class="main_top">
                        ...
                        <?php if($is_self_order=="Yes" && $is_online_order!="Yes"):?>
                            <div  style="display: <?php echo isset($is_kiosk_order) && $is_kiosk_order=="Yes"?"none":''?>" class="self_order_table_person_wrapper">
                        ...
                        <div class="bottom__info">
                            <div class="payable">
                                <h1>
                                    ...
                                    <i id="cart_item_option_open" class="fal fa-eye"></i> <?php echo lang('total_cash_due'); ?>:
                                    <span id="total_payable">$ <?php echo getAmtP(0)?></span>
                                </h1>
                            </div>
                            <div class="main_bottom">
                                

                                <div class="button_group <?php echo escape_output($is_self_order_class) ? 'self_order_mode': '' ?> <?php echo isset($is_kiosk_order) && $is_kiosk_order=="Yes"?"kiosk_self_order":''?>">
                                    ...
                                    <button class="placeOrderSound <?php echo isset($place_order_tooltip) && $place_order_tooltip=="show"?"btn_tip":'' ?>"  data-tippy-content="<?php echo lang('place_order_tooltip_txt'); ?>"  id="place_order_operation"><i
                                            class="fas fa-utensils"></i> <span
                                            id="place_edit_order"><?php echo lang('place_order'); ?></span></button>

                                </div>
                                
                                <div class="button_group <?php echo escape_output($is_self_order_class) ?> <?php echo escape_output($is_self_order_class) ? 'self_order_mode': '' ?>">

                                    <button class="for_invoice_btn_class_split_bill"><?php echo lang('split_bill'); ?></button>
                                    <button class="for_create_bill_and_close"><?php echo lang('bill'); ?></button>
                                    <button class="for_create_invoice_and_close"><?php echo lang('invoice'); ?></button>
            ...
            <div class="main_right <?php echo escape_output($is_self_order_class) ? 'online_order':'' ?>">
                <div autocomplete="off" class="search-category-form" id="search_form">
                    <?php  if(isFoodCourt() && $this->session->userdata('role') != 'Admin'):?>
                    <div class="search-category-item">
                        <div class="item">
                            <table style="width: 100%">
                                <tr>
                                    <?php /*<td><input class="" type="text" name="search" id="search" placeholder="<?php echo lang('name_code_cat_veg_bev_bar'); ?>" /></td> */?>
                                    <td>

                                    <td><input style="margin-top: -5px;" type="text" name="search_barcode" id="search_barcode" placeholder="<?php echo lang('scan_a_barcode'); ?>" /></td>


                                    <td>
                                        <ul class="btn__menu">
                                            <li style="display: <?php echo isset($is_kiosk_order) && $is_kiosk_order=="Yes"?"none":''?>">
                    ...
                    <?php else:   ?>
                        <table style="width: 100%">
                            <tr>
                                <?php /*<td> <input class="ir_w_m_b_4" type="text" name="search" id="search" placeholder="<?php echo lang('name_code_cat_veg_bev_bar'); ?>" /></td> */?>
                                <td></td>
                    ...
                    <div class="left-item b">
                       ...
                       $online_login_hide = 'none';
                        ...
                        <div class="customer_section" style="display:<?php echo escape_output($online_login)?>">
                            ...
                            <input type="email" class="add_customer_modal_input" id="customer_password_modal">
                        </div>
            ...
            <div class="select_table_modal_info_holder2">
                ...
                <div class="table-category-list">
                    <ul class="dineIn-table-list-of-item">
                        <li>
                            <a href="javascript:void(0)" class="get_area_table" data-id="all"><b><?php echo lang('area'); ?></b></a>
                        </li>
                        <?php
...
<div class="cus_pos_modal cus_pos_modal_self_online_sale_modal" id="customModalSelfOnlineOrder">
                        ...
                        <div class="left_item_list_wrapper">
                            <div class="page-content">
                                <div class="tabbed">
                                    ...
                                    <ul class="tabs">
                                        <li class="tab"><label for="tab1">Self Orders</label></li>
                                        <li class="tab"><label for="tab2">Online Orders</label></li>
                                    </ul>
            ...
            <div class="order_detail_modal_info_holder fix">
                ...
                <div class="create_invoice_close_order_in_order_details">
                    <button class="no-need-for-waiter" id="order_details_print_kot_button"><i
                            class="fas fa-file-invoice"></i>
                        <?php echo lang('kot_tooltip'); ?></button>
                </div>
    ...
    <div id="order_payment_modal" class="modal">
        ...
        <div class="modal-content">
            ...
            <h1 id="modal_item_name">
                <!-- <?php echo lang('Finalize'); ?> <?php echo lang('sale'); ?> -->
                <a href="javascript:void(0)" class="alertCloseIcon">
                    <i class="fal fa-times"></i>
                </a>
            </h1>
            ...
            <div class="finalize-modal-wrap">
                <div class="finalize-calculator-wrap">
                    <div class="finalize-calculator">
                        <div class="clear-trigger">
                            <div class="trigger-message">
                                <span class="text-center">Type Tender Amount & Select Tender Type</span>
                            </div>
                            <button class="btn clear-trigger" type="button">Clear</button>
                        </div>
                        <div class="mx-3">
                            <div class="dispaly-result-outline">
                                <div class="dispaly-result">
                                </div>
                            </div>
                            <div class="number-wrap">
                            <button class="btn number-trigger"><span>7</span></button>
                            <button class="btn number-trigger"><span>8</span></button>
                            <button class="btn number-trigger"><span>9</span></button>
                            <button class="btn number-trigger"><span>4</span></button>
                            <button class="btn number-trigger"><span>5</span></button>
                            <button class="btn number-trigger"><span>6</span></button>
                            <button class="btn number-trigger"><span>1</span></button>
                            <button class="btn number-trigger"><span>2</span></button>
                            <button class="btn number-trigger"><span>3</span></button>
                            <button class="btn number-trigger">.</button>
                            <button class="btn number-trigger"><span>0</span></button>
                            <button class="btn number-trigger">+/-</button>
                            </div>
                            <div class="calculator-footer">
                            <div class="text-center">
                                <span class="calculator-alert-msg">After $2.00 tax exempt from Food stamp</span>
                            </div>
                                <table style="border-collapse: collapse;width: 100%;margin-bottom: 12px;">
                                    <tr style="width: 50%" class="txt_zak_3">
                                        <td>Maximum Allowed in Food Stamps</td>
                                        <td>Remaining Amount</td>
                                    </tr>
                                    <tr style="width: 50%">
                                        <td class="txt_zak_1 finalize_total_payable"><?php echo getAmt(0)?></td>
                                        <td class="txt_zak_2 finalize_total_due"><?php echo getAmt(0)?></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
                    ...
                    <div class="cash">
                        <div class="payment-wrap">
                            ...
                            <div class="remaining-amount">
                                <p class="remaing-balance mt-0">Amount Remaining</p>
                                <p class="no-of-remaing-balance my-0 finalize_total_due"><?php echo getAmt(0)?></p>
                            </div>
                            <div class="payment-method-shwo">
                                <div class="payment-method-header">
                                <h4 class="my-0">Paid So Far</h4>
                                </div>
                                <table>
                                <thead>
                                    <tr>
                                ...
                                <button class="btn pay-btn-cancel mt-30 reset_payment_details">
                                    Cancel
                                </button>
                                </div>
                            </div>
                ...
                <div class="denomation-wrap">
                    <ul>
                    <li class="get_quick_cash">1.00</li>
                    <li class="get_quick_cash">5.00</li>
                    <li class="get_quick_cash">10.00</li>
                    <li class="get_quick_cash">20.00</li>
                    <li class="get_quick_cash">50.00</li>
                    <li class="get_quick_cash set_default_quick_cach"><?php echo getAmt(0)?></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div id="order_payment_modal_backup" class="modal">
        <!-- Modal content -->
        <div class="modal-content">
                ...
                <div class="finalize-calculator-wrap">
                    <div class="finalize-calculator">
                        ...
                        <div class="mx-3">
                            ...
                            <button class="btn"><span>0</span></button>
                            <button class="btn">+/-</button>
                            </div>
                            <div class="calculator-footer">
                            <div class="text-center">
                                <span class="calculator-alert-msg">After $0.00 exchange</span>
                            </div>
                            <div class="calculator-msg">
                                Maximus Allowed in Remaining Amount Food Stamps
                            </div>
                            <div class="footer-amount-show">
                                <div class="amount-el">
                                $0.00
                                </div>
                                <div class="amount-el">
                    ...
                    <div class="cash">
                        <div class="payment-wrap">
                            ...
                            <div class="remaining-amount">
                                <p class="remaing-balance mt-0">Amount Remaining</p>
                                <p class="no-of-remaing-balance my-0">$1.00</p>
                            </div>
                            <div class="payment-method-shwo">
                                <div class="payment-method-header">
                                <h4 class="my-0">Paid So Far</h4>
                                ...
                                <div class="text-right">
                                <button class="btn pay-btn-cancel mt-30">
                                    Cancel
                                </button>
                                </div>
                            </div>
                                    ...
                                    <div class="paid-list-wrapper">
                                        ...
                                        <div class="right-content">
                                            <div class="item">
                                                ...
                                                <p><?php echo escape_output($this->session->userdata('currency')); ?><span id="finalize_total_payable_backup"><?php echo getAmt(0)?></span></p>
                                            </div>
        ...
        <ul class="pos__menu__list scrollbar-macosx">
            ...
            <li class="have_sub_menu">
                ...
                <ul class="sub__menu__list">
                    <li class="menu_assign_class" data-menu__cid="irp_2"><a href="<?php echo base_url()?>Service/siteSetting">
                            <i class="fa fa-angle-double-right"></i> <?php echo lang('site_setting'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_2"><a href="<?php echo base_url()?>Service/emailSetting">
                            <i class="fa fa-angle-double-right"></i> <?php echo lang('email_setting'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_2"><a href="<?php echo base_url()?>Service/paymentSetting">
                            <i class="fa fa-angle-double-right"></i> <?php echo lang('Payment_Setting'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_2"><a href="<?php echo base_url()?>Service/addEditCompany">
                            <i class="fa fa-angle-double-right"></i> <?php echo lang('Add'); ?> <?php echo lang('Company'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_2"><a href="<?php echo base_url()?>Service/companies">
                            <i class="fa fa-angle-double-right"></i> <?php echo lang('List'); ?> <?php echo lang('Company'); ?></a></li>

                    <li class="menu_assign_class" data-menu__cid="irp_2"><a href="<?php echo base_url()?>Service/addManualPayment">
                            <i class="fa fa-angle-double-right"></i> <?php echo lang('Add'); ?> <?php echo lang('Manual_Payment'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_2"><a href="<?php echo base_url()?>Service/paymentHistory">
                            <i class="fa fa-angle-double-right"></i> <?php echo lang('List'); ?> <?php echo lang('Manual_Payment'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_2"><a href="<?php echo base_url()?>Service/addPricingPlan">
                            <i class="fa fa-angle-double-right"></i> <?php echo lang('Add'); ?> <?php echo lang('Pricing_Plan'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_2"><a href="<?php echo base_url()?>Service/pricingPlans">
                            <i class="fa fa-angle-double-right"></i> <?php echo lang('List'); ?> <?php echo lang('Pricing_Plan'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_2"><a href="<?php echo base_url()?>Service/reservationSetting">
                ...
                <ul class="sub__menu__list">
                    ...
                    <li class="have_sub_sub_menu">
                        ...
                        <ul class="sub__sub__menu__list">
                            <li><a href="<?php echo base_url()?>printer/addEditPrinter">
                                    <i class="fa fa-angle-double-right"></i> <?php echo lang('Add'); ?> <?php echo lang('Printer'); ?></a></li>
                            <li><a href="<?php echo base_url()?>printer/printers">
                                    <i class="fa fa-angle-double-right"></i> <?php echo lang('List'); ?> <?php echo lang('Printer'); ?></a></li>
                            <li><a href="<?php echo base_url()?>setting/invoicePrinterSetting">
                                    <i class="fa fa-angle-double-right"></i> <?php echo lang('invoice_printer_setting'); ?></a></li>
                            <li><a href="<?php echo base_url()?>setting/billPrinterSetting">
                                    <i class="fa fa-angle-double-right"></i> <?php echo lang('bill_printer_setting'); ?></a></li>
                            <li><a href="<?php echo base_url()?>setting/KOTPrinterSetting">
                                    <i class="fa fa-angle-double-right"></i> <?php echo lang('kot_printer_setting'); ?></a></li>
                        </ul>
                    </li>
                    <li><a href="<?php echo base_url()?>setting/tax">
                            <i class="fa fa-angle-double-right"></i> <?php echo lang('Tax_Setting'); ?></a></li>
                    <li><a href="<?php echo base_url()?>MultipleCurrency/addEditMultipleCurrency">
                            <i class="fa fa-angle-double-right"></i> <?php echo lang('Add'); ?> <?php echo lang('Multiple_Currency'); ?></a></li>
                    <li><a href="<?php echo base_url()?>MultipleCurrency/MultipleCurrencies">
                            <i class="fa fa-angle-double-right"></i> <?php echo lang('List'); ?> <?php echo lang('Multiple_Currency'); ?></a></li>
                   <?php if($company_id==1): ?>
                        <li><a href="<?php echo base_url()?>Update/index">
                                <i class="fa fa-angle-double-right"></i> <?php echo lang('software_update'); ?></a></li>
                        <li><a href="<?php echo base_url()?>Update/UninstallLicense">
                                <i class="fa fa-angle-double-right"></i> <?php echo lang('Uninstall_License'); ?></a></li>
                    <?php endif; ?>
                    <li><a href="<?php echo base_url()?>setting/selfOrder">
                            <i class="fa fa-angle-double-right"></i> <?php echo lang('sos_Self_Order_Setting'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_32"><a href="<?php echo base_url()?>setting/onlineOrder">
                            <i class="fa fa-angle-double-right"></i> <?php echo lang('sos_online_order_setting'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_2"><a href="<?php echo base_url()?>authentication/reservationSetting">
                            <i class="fa fa-angle-double-right"></i> <?php echo lang('reservationSetting'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_2"><a href="<?php echo base_url()?>setting/kioskSetting">
                            <i class="fa fa-angle-double-right"></i> <?php echo lang('kioskSetting'); ?></a></li>

                    <li class="menu_assign_class" data-menu__cid="irp_16"><a href="<?php echo base_url()?>paymentMethod/addEditPaymentMethod">
                            <i class="fa fa-angle-double-right"></i> <?php echo lang('Add'); ?> <?php echo lang('payment_method'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_16"><a href="<?php echo base_url()?>paymentMethod/paymentMethods">
                            <i class="fa fa-angle-double-right"></i> <?php echo lang('List'); ?> <?php echo lang('payment_method'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_16"><a href="<?php echo base_url()?>Denomination/addEditDenomination">
                            <i class="fa fa-angle-double-right"></i> <?php echo lang('Add'); ?> <?php echo lang('denomination'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_16"><a href="<?php echo base_url()?>Denomination/denominations">
                            <i class="fa fa-angle-double-right"></i> <?php echo lang('List'); ?> <?php echo lang('denomination'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_16"><a href="<?php echo base_url()?>DeliveryPartner/addEditDeliveryPartner">
                            <i class="fa fa-angle-double-right"></i> <?php echo lang('Add'); ?> <?php echo lang('deliveryPartner'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_16"><a href="<?php echo base_url()?>DeliveryPartner/deliveryPartners">
                            <i class="fa fa-angle-double-right"></i> <?php echo lang('List'); ?> <?php echo lang('deliveryPartner'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_16"><a href="<?php echo base_url()?>Area/addEditArea">
                            <i class="fa fa-angle-double-right"></i> <?php echo lang('Add'); ?> <?php echo lang('area'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_16"><a href="<?php echo base_url()?>Area/areas">
                            <i class="fa fa-angle-double-right"></i> <?php echo lang('List'); ?> <?php echo lang('area'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_16"><a href="<?php echo base_url()?>table/addEditTable">
                            <i class="fa fa-angle-double-right"></i> <?php echo lang('Add'); ?> <?php echo lang('table'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_16"><a href="<?php echo base_url()?>table/tables">
            ...
            if(str_rot13($language_manifesto)=="eriutoeri"):?>
                <li class="have_sub_menu">
                    ...
                    <ul class="sub__menu__list">
                        <li class="menu_assign_class" data-menu__cid="irp_3"><a href="<?php echo base_url()?>Outlet/addEditOutlet">
                                <i class="fa fa-angle-double-right"></i> <?php echo lang('Add'); ?> <?php echo lang('outlet'); ?></a></li>
                        <li class="menu_assign_class" data-menu__cid="irp_3"><a href="<?php echo base_url()?>Outlet/outlets">
                                <i class="fa fa-angle-double-right"></i> <?php echo lang('List'); ?> <?php echo lang('outlet'); ?></a></li>
                    </ul>
                </li>
            <?php else:?>
                <li><a href="<?php echo base_url()?>Outlet/addEditOutlet/<?php echo escape_output($outlet_id)?>">
                        <svg  width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-hard-drive"><line x1="22" y1="12" x2="2" y2="12"></line><path d="M5.45 5.11L2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z"></path><line x1="6" y1="16" x2="6.01" y2="16"></line><line x1="10" y1="16" x2="10.01" y2="16"></line></svg>
            ...
            <li class="have_sub_menu">
                ...
                <ul class="sub__menu__list">
                    <li class="menu_assign_class" data-menu__cid="irp_4"><a href="<?php echo base_url()?>POSChecker/posAndWaiterMiddleman">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('pos'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_4"><a href="<?php echo base_url()?>Kitchen/addEditKitchen">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('Add'); ?> <?php echo lang('kitchen'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_4"><a href="<?php echo base_url()?>Kitchen/kitchens">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('List'); ?> <?php echo lang('kitchen'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_4"><a href="<?php echo base_url()?>Waiter/panel">
            ...
            <li class="have_sub_menu">
                ...
                <ul class="sub__menu__list">
                    <li class="menu_assign_class" data-menu__cid="irp_6"><a href="<?php echo base_url()?>supplier/addEditSupplier">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('Add'); ?> <?php echo lang('supplier'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_6"><a href="<?php echo base_url()?>supplier/suppliers">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('List'); ?> <?php echo lang('supplier'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_6"><a href="<?php echo base_url()?>Purchase/addEditPurchase">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('Add'); ?> <?php echo lang('purchase'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_6"><a href="<?php echo base_url()?>Purchase/purchases">
            ...
            <li class="have_sub_menu">
                ...
                <ul class="sub__menu__list">
                    <li class="menu_assign_class" data-menu__cid="irp_6_1"><a href="<?php echo base_url()?>Production/addEditProduction">
                            <i class="fa fa-angle-double-right"></i> <?php echo lang('Add'); ?> <?php echo lang('production'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_6_1"><a href="<?php echo base_url()?>Production/productions">
            ...
            <li class="have_sub_menu">
                ...
                <ul class="sub__menu__list">
                    <li class="menu_assign_class" data-menu__cid="irp_7"><a href="<?php echo base_url()?>Transfer/addEditTransfer">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('Add'); ?> <?php echo lang('transfer'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_7"><a href="<?php echo base_url()?>Transfer/transfers">
            ...
            <li class="have_sub_menu">
                ...
                <ul class="sub__menu__list">
                    <li class="menu_assign_class" data-menu__cid="8"><a href="<?php echo base_url()?>Promotion/addEditPromotion">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('Add'); ?> <?php echo lang('promotion'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="8"><a href="<?php echo base_url()?>Promotion/promotions">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('List'); ?> <?php echo lang('promotion'); ?></a></li>

                    <li class="menu_assign_class" data-menu__cid="8"><a href="<?php echo base_url()?>customer/addEditCustomer">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('Add'); ?> <?php echo lang('customer'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="8"><a href="<?php echo base_url()?>customer/customers">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('List'); ?> <?php echo lang('customer'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="8"><a href="<?php echo base_url()?>customer/uploadCustomer">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('upload_customer'); ?></a></li>

                    <li class="menu_assign_class" data-menu__cid="8"><a href="<?php echo base_url()?>POSChecker/posAndWaiterMiddleman">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('Add'); ?> <?php echo lang('sale'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="8"><a href="<?php echo base_url()?>Sale/sales">
            ...
            <li class="have_sub_menu">
                ...
                <ul class="sub__menu__list">
                    <li class="menu_assign_class" data-menu__cid="irp_9"><a href="<?php echo base_url()?>Inventory/index">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('inventory'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_9"><a href="<?php echo base_url()?>Inventory/getInventoryAlertList">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('ingredients_alert'); ?></a></li>

                    <li class="menu_assign_class" data-menu__cid="irp_9"><a href="<?php echo base_url()?>Inventory_adjustment/addEditInventoryAdjustment">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('Add'); ?> <?php echo lang('inventory_adjustment'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_9"><a href="<?php echo base_url()?>Inventory_adjustment/inventoryAdjustments">
            ...
            <li class="have_sub_menu">
                ...
                <ul class="sub__menu__list">
                    <li class="menu_assign_class" data-menu__cid="irp_10"><a href="<?php echo base_url()?>Waste/addEditWaste">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('Add'); ?> <?php echo lang('waste'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_10"><a href="<?php echo base_url()?>Waste/wastes">
            ...
            <li class="have_sub_menu">
                ...
                <ul class="sub__menu__list">
                    <li class="menu_assign_class" data-menu__cid="irp_11"><a href="<?php echo base_url()?>expenseItems/addEditExpenseItem">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('Add'); ?> <?php echo lang('expense_item'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_11"><a href="<?php echo base_url()?>expenseItems/expenseItems">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('List'); ?> <?php echo lang('expense_item'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_11"><a href="<?php echo base_url()?>Expense/addEditExpense">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('Add'); ?> <?php echo lang('expense'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_11"><a href="<?php echo base_url()?>Expense/expenses">
            ...
            <li class="have_sub_menu">
                ...
                <ul class="sub__menu__list">
                    <li class="menu_assign_class" data-menu__cid="irp_12"><a href="<?php echo base_url()?>SupplierPayment/addSupplierPayment">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('Add'); ?> <?php echo lang('supplier_due_payment'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_12"><a href="<?php echo base_url()?>SupplierPayment/supplierPayments">
            ...
            <li class="have_sub_menu">
                ...
                <ul class="sub__menu__list">
                    <li class="menu_assign_class" data-menu__cid="irp_13"><a href="<?php echo base_url()?>Customer_due_receive/addCustomerDueReceive">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('Add'); ?> <?php echo lang('customer_due_receive'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_13"><a href="<?php echo base_url()?>Customer_due_receive/customerDueReceives">
            ...
            <li class="have_sub_menu">
                ...
                <ul class="sub__menu__list">
                    <li class="menu_assign_class" data-menu__cid="irp_14"><a href="<?php echo base_url()?>Attendance/addEditAttendance">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('Add'); ?> <?php echo lang('attendance'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_14"><a href="<?php echo base_url()?>Attendance/attendances">
            ...
            <li class="have_sub_menu">
                ...
                <ul class="sub__menu__list">
                    <li class="menu_assign_class" data-menu__cid="irp_12irp_12irp_15"><a href="<?php echo base_url()?>Report/registerReport">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('register_report'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_15"><a href="<?php echo base_url()?>Report/zReport">
                            <i class="fa fa-angle-double-right"></i> <?php echo lang('z_report'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_15"><a href="<?php echo base_url()?>Report/productAnalysisReport"> <i class="fa fa-angle-double-right"></i> <?php echo lang('productAnalysisReport'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_12irp_12irp_15"><a href="<?php echo base_url()?>Report/dailySummaryReport">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('daily_summary_report'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_15"><a href="<?php echo base_url()?>Report/foodMenuSales">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('food_sale_report'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_15"><a href="<?php echo base_url()?>Report/saleReportByDate">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('daily_sale_report'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_15"><a href="<?php echo base_url()?>Report/detailedSaleReport">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('detailed_sale_report'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_15"><a href="<?php echo base_url()?>Report/consumptionReport">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('consumption_report'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_15"><a href="<?php echo base_url()?>Report/inventoryReport">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('inventory_report'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_15"><a href="<?php echo base_url()?>Report/getInventoryAlertList">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('low_inventory_report'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_15"><a href="<?php echo base_url()?>Report/profitLossReport">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('profit_loss_report'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_15"><a href="<?php echo base_url()?>Report/attendanceReport">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('attendance_report'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_15"><a href="<?php echo base_url()?>Report/supplierLedgerReport">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('supplier_ledger_report'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_15"><a href="<?php echo base_url()?>Report/supplierDueReport">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('supplier_due_report'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_15"><a href="<?php echo base_url()?>Report/customerDueReport">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('customer_due_report'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_15"><a href="<?php echo base_url()?>Report/customerLedgerReport">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('customer_ledger_report'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_15"><a href="<?php echo base_url()?>Report/purchaseReportByDate">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('purchase_report'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_15"><a href="<?php echo base_url()?>Report/expenseReport">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('expense_report'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_15"><a href="<?php echo base_url()?>Report/wasteReport">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('waste_report'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_15"><a href="<?php echo base_url()?>Report/vatReport">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('vat_report'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_15"><a href="<?php echo base_url()?>Report/foodMenuSaleByCategories">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('foodMenuSaleByCategories'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_15"><a href="<?php echo base_url()?>Report/tipsReport">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('tips_report'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_15"><a href="<?php echo base_url()?>Report/auditLogReport">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('auditLogReport'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_15"><a href="<?php echo base_url()?>Report/availableLoyaltyPointReport">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('loyalty_point_report'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_15"><a href="<?php echo base_url()?>Report/usageLoyaltyPointReport">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('usage_loyalty_point_report'); ?></a></li>
                    <?php if(str_rot13($data_c[0]) == "eriutoeri"):?>
                        <li class="menu_assign_class" data-menu__cid="irp_15"><a href="<?php echo base_url()?>Report/transferReport">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('transferReport'); ?></a></li>
                    <?php endif;?>
                    <li class="menu_assign_class" data-menu__cid="irp_15"><a href="<?php echo base_url()?>Report/productionReport">
                            <i class="fa fa-angle-double-right"></i> <?php echo lang('productionReport'); ?></a></li>
            ...
            <li class="have_sub_menu">
                ...
                <ul class="sub__menu__list">
                    <li class="menu_assign_class" data-menu__cid="irp_16"><a href="<?php echo base_url()?>ingredientCategory/addEditIngredientCategory">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('Add'); ?> <?php echo lang('ingredient_category'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_16"><a href="<?php echo base_url()?>ingredientCategory/ingredientCategories">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('List'); ?> <?php echo lang('ingredient_category'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_16"><a href="<?php echo base_url()?>Unit/addEditUnit">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('Add'); ?> <?php echo lang('Ingredient_Unit'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_16"><a href="<?php echo base_url()?>Unit/Units">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('List'); ?> <?php echo lang('Ingredient_Unit'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_16"><a href="<?php echo base_url()?>ingredient/addEditIngredient">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('Add'); ?> <?php echo lang('ingredient'); ?></a></li>

                    <li class="menu_assign_class" data-menu__cid="irp_16"><a href="<?php echo base_url()?>ingredient/ingredients">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('List'); ?> <?php echo lang('ingredient'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_16"><a href="<?php echo base_url()?>modifier/addEditModifier">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('Add'); ?> <?php echo lang('modifier'); ?></a></li>

                    <li class="menu_assign_class" data-menu__cid="irp_16"><a href="<?php echo base_url()?>modifier/modifiers">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('List'); ?> <?php echo lang('modifier'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_16"><a href="<?php echo base_url()?>foodMenuCategory/addEditFoodMenuCategory">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('Add'); ?> <?php echo lang('food_menu_category'); ?></a></li>

                    <li class="menu_assign_class" data-menu__cid="irp_16"><a href="<?php echo base_url()?>foodMenuCategory/foodMenuCategories">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('List'); ?> <?php echo lang('food_menu_category'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_16"><a href="<?php echo base_url()?>foodMenu/addEditFoodMenu">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('Add'); ?> <?php echo lang('food_menu'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_16"><a href="<?php echo base_url()?>foodMenu/foodMenus">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('List'); ?> <?php echo lang('food_menu'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_16"><a href="<?php echo base_url()?>PreMadeFood/addEditPreMadeFood">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('Add'); ?> <?php echo lang('premade_food'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_16"><a href="<?php echo base_url()?>PreMadeFood/preMadeFoods">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('List'); ?> <?php echo lang('premade_food'); ?></a></li>
                </ul>
            </li>
            <li class="have_sub_menu">
                <a class="open-trigger" href="javascript:void(0)">
                ...
                <ul class="sub__menu__list">
                    <li class="menu_assign_class" data-menu__cid="irp_17"><a href="<?php echo base_url()?>Role/addEditRole">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('Add'); ?> <?php echo lang('role'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_17"><a href="<?php echo base_url()?>Role/roles">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('List'); ?> <?php echo lang('role'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_17"><a href="<?php echo base_url()?>User/addEditUser">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('Add'); ?> <?php echo lang('user'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_17"><a href="<?php echo base_url()?>User/users">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('List'); ?> <?php echo lang('user'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_17"><a href="<?php echo base_url()?>Authentication/changeProfile">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('change_profile'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_17"><a href="<?php echo base_url()?>Authentication/changePassword">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('change_password'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_17"><a href="<?php echo base_url()?>Authentication/changePin">
                            <?php echo lang('changePin'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_17"><a href="<?php echo base_url()?>Authentication/logOut">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('logout'); ?></a></li>
                    <li class="menu_assign_class" data-menu__cid="irp_17"><a href="<?php echo base_url()?>Authentication/securityQuestion">
                             <i class="fa fa-angle-double-right"></i> <?php echo lang('SetSecurityQuestion'); ?></a></li>

                </ul>
            </li>
            <?php if(isServiceAccess('','','sGmsJaFJE')): ?>
            <li><a href="<?php echo base_url()?>Plugin/plugins"><svg  width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file-text"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg> &nbsp; <?php echo lang('plugins'); ?></span></a></li>
            <?php endif;?>
            <li><a href="<?php echo base_url()?><?php echo base_url()?>Short_message_service/smsService"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-mail"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg> &nbsp; <?php echo lang('send_sms'); ?></span></a></li>
        </ul>
    </aside>
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>frequent_changing/js/pos_script112722.js"></script>
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/plugins/notify/jquery.notifyBar.js"></script>
    ...
    function setHeightInComponent(){
        ...
        // console.log(winHeight , r1 , r2 , r3 , r4 , r5 , r6 , 50, 'px')
       $('body').find('.main_center').css('height', winHeight - r1 - r2 - r3 - r4 - r5 - r6 - 50 + 'px');

    }

    // $(window).on('load',setHeightInComponent);
    // $(window).on('resize',setHeightInComponent);
    </script>

    <!--for datatable-->
    <?php /*
    <script src="<?php echo base_url(); ?>assets/datatable_custom/jquery-3.3.1.js"></script>
     * Duplicate script file
     */ ?>
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/POS/js/bespoke.js"></script>
    ...
    <script src="<?php echo base_url(); ?>frequent_changing/js/calculator.js"></script>
