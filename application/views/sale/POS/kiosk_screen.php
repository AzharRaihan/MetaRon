...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url();?>assets/POS/css/kiosk.css">
    <style>
                        ...
                        <div class="bottom__info">
                            ...
                            <div class="main_bottom">
                                <div class="button_group <?php echo escape_output($is_self_order_class) ?> <?php echo escape_output($is_self_order_class) ? 'self_order_mode': '' ?>">
                                    ...
                                    <button class=""><i class="fas fa-hand-rock"></i>
                                        </button>
                                    <button   ><i
                        ...
                        <div class="item">
                            <table style="width: 100%">
                                <tr>
                                    ...
                                    <td><input style="margin-top: -5px;padding-left: 42px;" type="text" name="search_barcode" id="search_barcode" placeholder="<?php echo lang('scan_a_barcode'); ?>" /></td>

                                    <td style="width: 1%">
                                        <a href="#" class="fullscreen" style="color:white">
                                            <i  class="fal fa-expand-arrows-alt"></i>
                                        </a>
                                    </td>
                                </tr>
...
<div class="cus_pos_modal cus_pos_modal_self_online_sale_modal" id="customModalSelfOnlineOrder">
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>frequent_changing/js/pos_script222010.js"></script>
