            ...
            <div class="row">
                        ...
                        foreach ($categories as $category) {
                            ...
                            <div class="col-sm-12 mb-3 col-md-6 col-lg-3">
                                ...
                                <label class="container txt_47" for="checker_<?php echo $category->id?>"> <?="<b>".$category->category_name."</b>"?>
                                    <input class="checkbox_user parent_class" id="checker_<?php echo $category->id?>" data-name="<?php echo str_replace(' ', '_', $category->category_name)?>" value="<?=$category->id?>" type="checkbox" name="item_check[]">
                                    <span class="checkmark"></span>
                                </label>
                                <br>
                                </div>
                ...
                <div class="col-sm-12 mb-2 col-md-3">
                    <div class="form-group">
                        ...
                        <select class="form-control select2 kitchen_use_type" name="kitchen_use_type">
                            ...
                            <option <?php echo set_select('kitchen_use_type',"1")?> value="1"><?php echo lang('ViaPanel'); ?></option>
                        </select>
                    </div>
                ...
                <div class="col-sm-12 mb-2 col-md-3 printer_div ir_display_none_normal">
                    <div class="form-group">
                        ...
                        <input tabindex="1" autocomplete="off" type="text" name="print_server_url" class="form-control" placeholder="<?php echo lang('print_server_url'); ?>" value="<?php echo set_value('print_server_url'); ?>" />
                    </div>
