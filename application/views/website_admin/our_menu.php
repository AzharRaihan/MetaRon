...
<section class="main-content-wrapper">
    ...
    <section class="content-header">
        <h1><?php echo lang('our_menu_setting');?></h1>
    </section>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 mb-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="<?php echo lang('title');?>" id="title" name="title" value="<?php echo escape_output($our_menu->title);?>">
                    ...
                    <div class="col-lg-4 col-md-6 mb-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="<?php echo lang('sub_title');?>" id="sub_title" name="sub_title" value="<?php echo escape_output($our_menu->sub_title);?>">
                    ...
                    <div class="col-lg-4 col-md-6 mb-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="<?php echo lang('description');?>" id="description" name="description" value="<?php echo escape_output($our_menu->description);?>">
                    ...
                    <div class="col-lg-4 col-md-6 mb-3">
                        <div class="form-group">
                            ...
                            <select name="status" id="status" class="form-control select2">
                                <option value="Active" <?php echo $our_menu->status == escape_output('Active') ? 'selected' : ''?>> <?php echo lang('active');?></option>
                                <option value="Inactive" <?php echo $our_menu->status == escape_output('Inactive') ? 'selected' : ''?>><?php echo lang('inactive');?></option>
                            </select>
                    ...
                    <div class="col-lg-4 col-md-6 mb-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control set_no_link_val" placeholder="<?php echo lang('link');?>" id="link" name="link" value="<?php echo escape_output($our_menu->link);?>">
                    ...
                    <div class="col-lg-4 col-md-6 mb-3">
                        <div class="form-group">
                            ...
                            <input type="hidden" name="menu_img_1" id="put_old_value_1"  value="<?php echo escape_output($our_menu->menu_img_1);?>">
                    ...
                    <div class="col-lg-4 col-md-6 mb-3">
                        <div class="form-group">
                            <div class="d-flex justify-content-between">
                                <label for="" class="form-label"><?php echo lang('select_image');?><span class="text-danger ms-2"><?php echo lang('menu_img_2_dimension');?></span></label>
                                <button type="button" class="btn bg-sm-blue-btn mb-1" data-bs-toggle="modal" data-bs-target="#showImageModal2">
                                        <?php echo lang('show_image')?>
                                </button>
                            </div>
                            <input type="file" class="form-control" name="menu_img_2" id="menu_img_2">
                            <input type="hidden" name="menu_img_2" id="put_old_value_2"  value="<?php echo escape_output($our_menu->menu_img_2);?>">
                            <div class="callout callout-danger my-2 error-msg menu_img_2_err_msg_contnr">
                                <p id="menu_img_2_err_msg"></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 mb-3">
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control" name="menu_img_3" id="menu_img_3">
                            <input type="hidden" name="menu_img_3" id="put_old_value_3"  value="<?php echo escape_output($our_menu->menu_img_3);?>">
                            <div class="callout callout-danger my-2 error-msg menu_img_3_err_msg_contnr">
                                <p id="menu_img_3_err_msg"></p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div id="set_modal_image_1" class="text-center">
                    <img src="<?php echo base_url();?>images/website/our_menu/<?php echo escape_output($our_menu->menu_img_1)?>" alt="" width="280" height="400" class="text-center">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div id="set_modal_image_2" class="text-center">
                    <img src="<?php echo base_url();?>images/website/our_menu/<?php echo escape_output($our_menu->menu_img_2)?>" alt="" width="330" height="220" class="text-center">
                </div>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="showImageModal3" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="showImageModal3Label" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModal3Label"><?php echo lang('show_image');?></h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                <i class="fa fa-times"></i>
                </button>
            </div>
            <div class="modal-body">
                <div id="set_modal_image_3" class="text-center">
                    <img src="<?php echo base_url();?>images/website/our_menu/<?php echo escape_output($our_menu->menu_img_3)?>" alt="" width="330" height="220" class="text-center">
                </div>
            </div>
        </div>
    </div>
...
<script src="<?php echo base_url(); ?>website_assets/js/our_menu.js"></script>
