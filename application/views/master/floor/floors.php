...
<section class="main-content-wrapper">
    ...
    <section class="content-header">
        <div class="row">
            <div class="col-sm-12">
                <h2 class="top-left-header"><?php echo lang('floors'); ?> </h2>
                <input type="hidden" class="datatable_name" data-title="<?php echo lang('floors'); ?>" data-id_name="datatable">
            </div>
            <div>
                <a class="btn_list m-right btn bg-blue-btn" href="<?php echo base_url() ?>floor/addEditFloor">
                   <i data-feather="plus"></i> <?php echo lang('add_floor'); ?>
                </a>
            </div>
        </div>
    </section>
                    ...
                    <table id="datatable" class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo escape_output($value->floor_name) ?></td>
                                ...
                                <td class="ir_txt_center">
                                    <div class="btn-group  actionDropDownBtn">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton1" role="menu">
                                            <li><a
                                                    href="<?php echo base_url() ?>floor/addEditFloor/<?php echo escape_output($this->custom->encrypt_decrypt($value->id, 'encrypt')); ?>"><i
                                                        class="fa fa-pencil tiny-icon"></i><?php echo lang('edit'); ?></a>
                                            </li>
                                            <li><a class="delete"
                                                    href="<?php echo base_url() ?>floor/deleteFloor/<?php echo escape_output($this->custom->encrypt_decrypt($value->id, 'encrypt')); ?>"><i
