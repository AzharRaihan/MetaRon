<section class="main-content-wrapper">
    ...
    <section class="content-header">
        <div class="row">
            ...
            <div>
                <a class="btn bg-blue-btn m-right btn_list" href="<?php echo base_url() ?>MultipleCurrency/addEditMultipleCurrency">
                    <i data-feather="plus"></i> <?php echo lang('add_MultipleCurrency'); ?>
                </a>
            </div>
        </div>
    </section>
