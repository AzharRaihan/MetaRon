    			...
    			<div class="table-box">
    				<div class="bozx-body">
    					<div class="row ">
                            ...
                            <div class="col-6 col-sm-6 col-md-auto mb-3">
                                <a href="#customer_ledger_id" class="tablinks" onClick="report_section_get(event,'customer_ledger_id')" id="customer_ledger_tab">
                                    <div class="card white_card">
                                        <div class="card-body">
                                            <div class="image-box">
                            ...
                            <div class="col-6 col-sm-6 col-md-auto mb-3">
                                <a href="#tax_report_id" class="tablinks" onClick="report_section_get(event,'tax_report_id')" id="tax_report_tab">
                                    <div class="card white_card">
                                        <div class="card-body">
                                            <div class="image-box">
                            ...
                            <div class="col-6 col-sm-6 col-md-auto mb-3">
                                <a href="#food_menu_sale_by_category_id" class="tablinks" onClick="report_section_get(event,'food_menu_sale_by_category_id')" id="food_menu_sale_by_category_tab">
                                    <div class="card white_card">
                                        <div class="card-body">
                                            <div class="image-box">
