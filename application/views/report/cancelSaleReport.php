...
<section class="main-content-wrapper">
    <section class="content-header">
        <h3 class="top-left-header text-left"><?php echo lang('cancelSaleReport'); ?></h3>
        <input type="hidden" class="datatable_name" data-title="<?php echo lang('cancelSaleReport'); ?>" data-id_name="datatable">
    ...
    <div class="box-wrapper">
        <div class="row">
            <div class="col-sm-12 mb-3 col-md-4 col-lg-2">
                <?php echo form_open(base_url() . 'Report/cancelSaleReport') ?>
            ...
            <div class="col-sm-12 mb-3 col-md-4 col-lg-2" style="display: none">
                <div class="form-group">
            ...
            <div class="table-responsive">
                ...
                <table id="datatable" class="table">
                    ...
                    <tr>
                        ...
                        <th><?php echo lang('cancelled_by'); ?></th>
                        <th><?php echo lang('cancellation_reason'); ?></th>
                    </tr>
                    </thead>
                    <tbody>
                    <?php
                    ...
                    if (isset($detailedSaleReport)):
                        foreach ($detailedSaleReport as $key => $value) {
                            ...
                            <tr>
                                ...
                                <td><?php echo escape_output($value->cancellation_reason) ?></td>
                            </tr>
                            <?php
                        }
                    endif;
