            ...
            <div id="receipt-data">
               ...
               <p><?php echo lang('date'); ?>: <?= escape_output(date($this->session->userdata('date_format'), strtotime($sale_object->sale_date))); ?>
                   ...
                   <br /><?php echo lang('table'); ?>:
                    ...
                    <?php if($sale_object->number_of_guest){?>
                   <br /><?php echo lang('number_of_guest'); ?>:
                    <b>
                        <?php
                        echo escape_output($sale_object->number_of_guest);
                    }
                    ?>
                    </b>
                    <?php } ?>
                    ...
                    foreach ($sale_object->items as $row) {
                        ...
                        <tr>
                            <td class="no-border border-bottom ir_wid_70"># <?php echo escape_output($i++); ?>:
                                &nbsp;&nbsp;<?php echo escape_output(fm_separateMultiLang($row->food_menu_id,$sale_object->invoice_lang)) ?>
                ...
                ?>
                    ...
                    <tfoot>
                        ...
                        ?>
                            <tr>
                                <th><?php echo lang($sale_object->charge_type); ?> <?php echo escape_output((getPlanTextOrP($sale_object->delivery_charge))); ?></th>
                                <th class="text-right">
                                    <?php echo escape_output((getAmt($sale_object->delivery_charge_actual_charge))); ?>
                                </th>
                            </tr>
                        <?php
                        endif;
