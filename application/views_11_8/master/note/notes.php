...
<section class="main-content-wrapper">
    ...
    <section class="content-header">
        <div class="row">
            <div class="col-sm-12">
                <h2 class="top-left-header"><?php echo lang('notes'); ?> </h2>
                <input type="hidden" class="datatable_name" data-title="<?php echo lang('notes'); ?>" data-id_name="datatable">
            </div>
            <div>
                <a class="btn_list m-right btn bg-blue-btn" href="<?php echo base_url() ?>note/addEditNote">
                   <i data-feather="plus"></i> <?php echo lang('add_note'); ?>
                </a>
            </div>
        </div>
    </section>
                                ...
                                <td class="ir_txt_center">
                                    <div class="btn-group  actionDropDownBtn">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton1" role="menu">
                                            <li><a
                                                    href="<?php echo base_url() ?>note/addEditNote/<?php echo escape_output($this->custom->encrypt_decrypt($value->id, 'encrypt')); ?>"><i
                                                        class="fa fa-pencil tiny-icon"></i><?php echo lang('edit'); ?></a>
                                            </li>
                                            <li><a class="delete"
                                                    href="<?php echo base_url() ?>note/deleteNote/<?php echo escape_output($this->custom->encrypt_decrypt($value->id, 'encrypt')); ?>"><i
