                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input tabindex="6"  onfocus="select();"  type="text" id="code" name="code" class="form-control"
                            ...
                            <div class="form-group">
                                ...
                                <select tabindex="5" class="txt_21 form-control select2 select2-hidden-accessible"
                                    ...
                                    <?php foreach ($food_menus as $ingnts) {
                                        if($food_menu_details->id!=$ingnts->id):
                                        ?>
                                        <option data-name="<?php echo escape_output($ingnts->name); ?>"
