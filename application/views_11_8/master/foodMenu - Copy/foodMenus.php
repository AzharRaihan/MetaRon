                     ...
                     <table id="datatable" class="table table-striped">
                         <thead>
                             <tr>
                                 ...
                                 <th class="ir_w_25"><?php echo lang('Variation'); ?>(<?php echo lang('code'); ?>)-<?php echo lang('sale_price'); ?></th>
                             ...
                             <tr>
                                 ...
                                 <td class="arabic_text_left">
                                     ...
                                     foreach ($value->variations as $key=>$val):?>
                                         <?php echo escape_output($val->name) ?>(<?php echo escape_output($val->code) ?>) - <?php echo escape_output(getAmtP($val->sale_price)) ?>
                                         <?php
