...
class Common_model extends CI_Model {
    ...
    /**
     * get Active All Data By Company Id
     * @access public
     * @return object
     * @param int
     * @param string
     */
    public function getActiveAllDataByCompanyId($company_id, $table_name) {
        $result = $this->db->query("SELECT * 
          FROM $table_name 
          WHERE company_id=$company_id AND status = 'Active'  AND del_status = 'Live'
          ORDER BY id DESC")->result();
        return $result;
    }
    /**
    ...
    public function getAllData($table_name) {
        $result = $this->db->query("SELECT * 
          FROM $table_name 
          WHERE status = 'Active' AND del_status = 'Live'  
          ORDER BY id DESC")->result();
        return $result;
    }
    /**
     ...
     * @param string
     */
    public function getActiveDataById($id, $table_name) {
        $this->db->select("*");
        $this->db->from($table_name);
        $this->db->where("id", $id);
